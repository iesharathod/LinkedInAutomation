...
Label(root, text="Keywords").grid(row=2)
Label(root, text="Pages").grid(row=3)
...
Button(root, text='Start', command=lambda: start_automate(e1, e2, e3, e4, root)).grid(row=4, column=1, sticky=W, pady=4)
